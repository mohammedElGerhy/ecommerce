...
@section('script')
    ...
    <script>
        ...
        AIzaSyB9jvtgSU3IwA_Bw405_h0x7nCCvLkOvxA
    </script>AIzaSyAEwWH2O-yL0Pg1TFfr3fR3OeP4TCiKSZs 
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB9jvtgSU3IwA_Bw405_h0x7nCCvLkOvxA&callback=initAutocomplete&language=ar&region=EG
         async defer"></script>
    @stop
