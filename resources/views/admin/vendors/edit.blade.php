...
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB9jvtgSU3IwA_Bw405_h0x7nCCvLkOvxA&libraries=places&callback=initAutocomplete&language=ar&region=EG
         async defer"></script>
@stop
